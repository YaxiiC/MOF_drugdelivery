...
with open("svm_skipped_cifs.log", "w") as f:
...
# =========================
print("\n===== 5-fold Cross Validation (SVR on handcrafted features) =====")
...
for train_idx, val_idx in kfold.split(X_feats):
    ...
    # Scale features for SVM (SVM is sensitive to feature scales)
...
# =========================
# 5. Define non-DGL model: SVR regression (DeepChem wrapper)
# =========================
# Note: For DeepChem SklearnModel with SVR, we need to handle scaling
# We'll create a pipeline with StandardScaler + SVR
...
print("\nFitting SVR model on train set...")
